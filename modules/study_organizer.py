...
class study_organizer(object):
        ...
        if multiproc:
            ...
            with futures.ProcessPoolExecutor(max_workers=workers) as executor:
                ...
                for study in studies:
                    ...
                    pat_df = dir_df[dir_df['study'] == study]
            ...
            for study in studies:
                ...
                result, study = self.validation_runner(output_path, pat_df, answer_df, uids_old_to_new, study, log_path, log_level)
                validation_dfs.append(result)
    ...
    def validation_runner(self, output_path, data_df, answer_df, uids_old_to_new, study, log_path, log_level):
        ...
        # Prep Answer Data
        #-------------------------------------
        logging.info(f'Patient:{study} - Answer Data Prep Started')
        ...
        logging.debug(f'Patient:{study} - Answer Records: {len(study_answer_df)}')
        logging.info(f'Patient:{study} - Answer Data Prep Complete')

        #-------------------------------------
        # Validate Data
        #-------------------------------------
        logging.info(f'Patient:{study} - Validation Started')
        ...
        logging.debug(f'Patient:{study} - Validation Records: {len(study_validation_df)}')
        logging.info(f'Patient:{study} - Validation Complete')
